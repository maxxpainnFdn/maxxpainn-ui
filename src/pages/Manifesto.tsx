          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-20">
              <div className="inline-block mb-6">
                <div className="flex items-center gap-3 px-6 py-3 bg-pink-900/30 border border-pink-500/50 rounded-full">
                  <Flame className="w-5 h-5 text-pink-400 animate-pulse" />
                  <span className="text-pink-300 font-bold uppercase tracking-wider text-sm">Born from Pain</span>
                </div>
              </div>
              ...
              <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-6">
                ...
                <span className="text-pink-600">MANIFESTO</span>
              </h1>
