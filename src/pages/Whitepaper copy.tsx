...
const TABLE_OF_CONTENTS = [
  ...
  { id: 'introduction',      label: 'The Market Warzone',    icon: Flame,         color: 'text-maxx-pink'    },
  ...
  { id: 'reward-algorithm',  label: 'The Laws of Pain',      icon: Calculator,    color: 'text-yellow-400'   },
  ...
  { id: 'clan-system',       label: 'Clan Warfare',          icon: Skull,         color: 'text-maxx-violet'  },
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-lg bg-maxx-bg1/80 border border-maxx-violet/25 mb-8">
                  <Skull className="w-4 h-4 text-maxx-violet" />
                  <span className="eyebrow mb-0">Classified Doctrine</span>
              ...
              <div className="flex flex-col xl:flex-row gap-10">
                ...
                <div className="flex-1 min-w-0 space-y-16">
                  ...
                  <Section id="abstract">
                    ...
                    <Card>
                      <Lead>
                        A native Solana protocol forged for the survivors of the trenches. 
                        <span className="text-maxx-violet font-bold"> MAXXPAINN</span> is a zero-entry 
                        extraction layer that turns your market trauma into liquid assets.
                      </Lead>
                      <Para>
                        Share your scars to earn your rank, and let time lock it in. By weaponizing Proof-of-Patience (PoP), the protocol rewards the conviction to endure over those with the deepest pockets.
                      </Para>
                      <Para>
                        The protocol introduces a novel{' '}
                        <span className="text-maxx-violet font-semibold">Rank-Based Difficulty Adjustment</span>{' '}
                        system that progressively increases the cost of minting via physical account storage rent as
                        participation grows. This creates natural economic pressure that transitions the ecosystem
                        from mint-dominated to market-dominated over time.
                      </Para>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                        ...
                        <MetricCard label="Standard"       value="SPL"   footnote="Token-2022 Extensions"       border="border-maxx-violet/30"     bg="bg-maxx-violet/10"     text="text-maxx-violetLt"  />
                  ...
                  <Section id="introduction">
                    <SectionHeader number="02" Icon={Flame} title="The Market Warzone" badge="bg-maxx-pink/10 border-maxx-pink/30 text-maxx-pink" />
                    <Card>
                      <SubTitle Icon={AlertTriangle} iconClass="text-red-400">The Slaughterhouse of Traditional Launches</SubTitle>
                      <Para>
                        ...
                        Most token launches reward speed, capital, and proximity to developers. They do not reward conviction.
                      </Para>
                    ...
                    <Card>
                      <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-5 rounded-lg bg-maxx-bg0/60 border border-maxx-violet/15 mb-6">
                        {[
                          ...
                          { Icon: Cpu,      label: 'Anchor',  tw: 'bg-blue-500/10    border-blue-500/30    text-blue-400'    },
                      ...
                      <Para>
                        We do not use artificial barriers. We weaponize the physical constraints of the Solana ledger. Instead of an arbitrary hashing difficulty, the cost to mint is pegged to the physical growth of the protocol’s state via Rent-Exempt requirements.
                      </Para>
                      <Para>
                        Furthermore, <span className="text-maxx-violet font-bold">only the protocol can close accounts</span>. This solves the "rent-drain" problem, allowing the centralized treasury (managed via on-chain governance/authority) to harvest the rent to fund its own ecosystem.
                      </Para>
                    </Card>
                  </Section>
                    ...
                    <Card>
                      ...
                      <div className="relative mt-6">
                        ...
                        <div className="space-y-6">
                          {[
                            { phase: '1', title: 'The Blood Oath (Claim Rank)',  duration: 'Instant',          cost: 'Dynamic SOL', desc: 'The user begins by permanently committing their story of market trauma to the ledger, locking in their rank and selecting a wait duration.' },
                            ...
                            { phase: '3', title: 'The Extraction (Claim Tokens)',duration: 'Instant',          cost: 'Gas Only',    desc: 'The lock expires. You have exactly 7 days to mint your tokens. Miss the window, and severe late penalties destroy your allocation.' },
                  ...
                  <Section id="reward-algorithm">
                    ...
                    <Card className="mt-6">
                      ...
                      <Para>
                        The LPM incentivizes long-term commitment.
                        By locking tokens for extended periods,
...
fn get_storage_fee(rank_no: u64) -> u64 {
    ...
    return base * root * scale;
                  ...
                  <Section id="clan-system">
                    <SectionHeader number="09" Icon={Users} title="Clan Warfare" badge="bg-maxx-violet/10 border-maxx-violet/30 text-maxx-violet" />
                    <Card>
                      <Lead>You do not survive the trenches alone. Clans are the digital barracks where like-minded survivors gather to liquidate their trauma.</Lead>
                      <Para>
                        Most projects fail because they rely on unsustainable VC marketing budgets. MAXXPAINN replaces marketing teams with a <strong className="text-maxx-violet">cult-driven affiliate structure</strong> built directly into the core protocol state.
                      </Para>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-6">
                        {[
                          { Icon: Users,   tw: 'bg-maxx-violet/10 border-maxx-violet/30 text-maxx-violet', title: 'Create or Join', desc: 'Join an existing clan or create your own to build your barracks.' },
                          { Icon: Network, tw: 'bg-blue-500/10    border-blue-500/30    text-blue-400',    title: 'Share & Extract', desc: 'Liquidate your trauma. Every new mint through your referral links your accounts.' },
                          { Icon: Coins,   tw: 'bg-green-500/10   border-green-500/30   text-green-400',   title: 'Rent Harvest',   desc: `Extract 25% to 50% of the Reclaimed SOL Rent when the protocol eventually closes the user's account.` },
                      ...
                      <div className="mt-6 p-4 rounded-lg bg-red-950/20 border border-red-500/20">
                        <p className="text-sm font-mono text-maxx-mid leading-relaxed">
                          <span className="text-red-400 font-bold mr-2">SYSTEM NOTE:</span> 
                          Only the overarching protocol authority has the right to close an account. This prevents malicious actors from sniping rent and ensures the Clan Leader payout is mathematically guaranteed by the smart contract upon account termination.
                        </p>
                      </div>
                    </Card>
                  </Section>
