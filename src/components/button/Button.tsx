...
const Button: React.FC<ButtonProps> = ({
  ...
  const gradientVariants: Record<ButtonVariant, string> = {
    ...
    danger: 'bg-gradient-to-r from-pink-700 to-pink-800 hover:from-pink-850 hover:to-pink-900 text-white font-semibold sm:font-bold shadow-lg shadow-pink-600/30 hover:shadow-pink-600/50',

    success: 'bg-gradient-to-r from-green-600 to-green-700 hover:from-green-650 hover:to-green-750 text-white font-semibold sm:font-bold shadow-lg shadow-green-500/30',
  ...
  // Hover effects
  const hoverEffect = variant !== 'link' ? 'hover:scale-103 active:scale-95' : '';
