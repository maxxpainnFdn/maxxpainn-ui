  ...
  return (
    <div className="relative w-full xs:w-[180px] sm:w-[220px]">
      <button
        ...
        className="w-full h-14 px-4 bg-gray-800/60 backdrop-blur-sm border-2  border-purple-500/10 rounded-xl text-white font-medium hover:border-purple-500/20 transition-all duration-300 flex items-center justify-between"
      >
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute top-full mt-2 w-full bg-gray-900/95 backdrop-blur-xl border-2 border-purple-500/30 rounded-xl max-h-[250px] shadow-2xl z-20 overflow-x-hidden">
