...
import { ChevronRight, Skull, Zap, Coins, ArrowRight, Flame } from 'lucide-react';
...
const EnhancedStorySection = () => {
  ...
  const painPoints = [
    {
      ...
      description: "Remember when LUNA went from \$80 to \$0.0001? Pepperidge Farm remembers.",
      icon: "🌙",
      loss: "$60B",
      detail: "Do Kwon promised the moon, delivered the grave. 280,000 BTC couldn't save us.",
      accentColor: "from-blue-500/20 to-purple-500/20",
      borderColor: "border-blue-500/30 hover:border-blue-500/60"
    },
    {
      title: "FTX Betrayal", 
      description: "Trusted SBF with our life savings. Got backstabbed by a fraud.",
      icon: "💔",
      loss: "$8B",
      detail: "The golden boy of crypto was just another con artist in a hoodie.",
      accentColor: "from-red-500/20 to-orange-500/20",
      borderColor: "border-red-500/30 hover:border-red-500/60"
    },
    {
      title: "Endless Rugs",
      description: "How many 'revolutionary' projects vanished with our dreams?",
      icon: "🪦",
      loss: "$10B+",
      detail: "SafeMoon, Iron Finance, Titan... The graveyard keeps growing.",
      accentColor: "from-purple-500/20 to-pink-500/20",
      borderColor: "border-purple-500/30 hover:border-purple-500/60"
    },
    {
      title: "Liquidation Hell",
      description: "100x leverage seemed smart until it wasn't. Dreams crushed in milliseconds.",
      icon: "⚡",
      loss: "$50B+",
      detail: "One red candle. That's all it took to delete years of savings.",
      accentColor: "from-yellow-500/20 to-red-500/20",
      borderColor: "border-yellow-500/30 hover:border-yellow-500/60"
    },
    {
      title: "Exchange Hacks",
      description: "Mt. Gox, Bitfinex, QuadrigaCX... Our funds, their 'mistakes'.",
      icon: "🏴‍☠️",
      loss: "$15B+",
      detail: "Not your keys, not your coins. We learned this the hard way.",
      accentColor: "from-orange-500/20 to-red-500/20",
      borderColor: "border-orange-500/30 hover:border-orange-500/60"
    },
    {
      title: "Ponzi Paradise",
      description: "Bitconnect, OneCoin, PlusToken... We fell for them all.",
      icon: "🎪",
      loss: "$25B+",
  ...
  return (
    <section id="story" className="relative py-24 overflow-hidden bg-gradient-to-br from-gray-900 via-black to-purple-900/20">
      
      {/* --- BACKGROUND LAYERS (Matched to Hero) --- */}
       <div className="absolute inset-0 pointer-events-none">
         {/* Animated gradient orbs */}
         <div className="absolute inset-0 opacity-15">
           <div className="absolute top-40 left-20 w-96 h-96 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
           <div className="absolute bottom-40 right-20 w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
           <div className="absolute top-1/3 right-1/3 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '9s', animationDelay: '4s' }} />
         </div>
         ...
         {/* Floating shapes */}
         <div className="absolute top-20 left-20 w-4 h-4 border-2 border-red-500/30 rotate-45 animate-spin" style={{ animationDuration: '20s' }} />
         <div className="absolute bottom-40 right-32 w-6 h-6 border-2 border-purple-500/30 rounded-full animate-ping" style={{ animationDuration: '4s' }} />
         <div className="absolute top-1/2 left-16 w-3 h-3 bg-pink-500/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed font-light">
            ...
            <span className="text-white font-medium ms-1">But from this collective pain, we forge our strength.</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {painPoints.map((point, index) => (
            ...
            >
              {/* Internal glow */}
              <div className={`absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-gradient-to-b ${point.accentColor} blur-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500`} />
              ...
              <div className="relative z-10 text-center">
                ...
                {/* Expanded Detail */}
                <div className={`overflow-hidden transition-all duration-300 ${selectedPain === index ? 'max-h-24 opacity-100 mt-4' : 'max-h-0 opacity-0'}`}>
              ...
              {/* Hover indicator */}
              <div className={`absolute bottom-4 right-4 transition-all duration-300 ${selectedPain === index ? 'rotate-90 opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
              <div className="max-w-2xl text-center md:text-left">
                ...
                <p className="text-gray-400 text-lg mb-4 leading-relaxed">
                  Every crash taught us resilience. Every rug made us wiser. Every liquidation forged our determination.
                </p>
