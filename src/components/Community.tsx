...
const Community = () => {
  ...
  const testimonials = [
    ...
    {
      name: "LunaVictim",
      story: "Terra collapse took everything. This community saved my sanity.",
      pain: "LUNA SURVIVOR",
      rank: "VETERAN"
    },
    {
      name: "LeveredUp",
      story: "Liquidated my house deposit. MAXXPAINN is my redemption arc.",
      pain: "LIQUIDATED",
      rank: "OFFICER"
    },
    {
      name: "RugSurvivor",
      story: "Every failed project made me stronger. Now we rise together.",
      pain: "SURVIVOR",
      rank: "SOLDIER"
    }
  ];
    ...
    <section className="relative py-32 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-15">
          ...
          <div className="absolute bottom-20 left-10 w-[500px] h-[500px] bg-pink-500 rounded-full mix-blend-multiply filter blur-[100px] animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg xs:text-xl sm:text-2xl text-gray-400 max-w-2xl mx-auto font-light">
            <span className="text-white font-bold">127K+ degens</span> who earned their spot through pain
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          ...
          {/* Twitter Card */}
          <a href="#" className="group relative bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-black hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">The Loudspeaker</h3>
              <p className="text-gray-400 mb-6 flex-grow">Alpha calls, shitposting, and coping together. Join the conversation.</p>
          ...
          {/* Telegram Card */}
          <a href="#" className="group relative bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-black hover:border-green-500/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">The War Room</h3>
              <p className="text-gray-400 mb-6 flex-grow">Live coordinated raids and mental health support. 24/7 active.</p>
          ...
          {/* Discord/Blog Card */}
          <a href="#" className="group relative bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-black hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">The Bunker</h3>
              <p className="text-gray-400 mb-6 flex-grow">Deep dive research, governance proposals, and roadmap updates.</p>
