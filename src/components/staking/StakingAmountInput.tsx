    ...
    >
      ...
      <div className="relative">
        <CurrencyInput
          ...
          disabled={isStaking}
          defaultValue={0}
          className="w-full bg-gray-800/60 border-2 border-purple-500/10 rounded-2xl px-6 py-4 pr-[100px] text-white text:lg sm:text-xl md:text-2xl font-black focus:border-purple-500/60 focus:outline-none  placeholder:text-gray-700"
        />
        <button
