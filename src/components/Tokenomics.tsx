...
import { Scale, Ticket, Flame, Vote, Wallet, FileText, Sparkles, Zap, Ban } from 'lucide-react';

const Tokenomics = () => {
  const features = [
    {
      title: "Fair Launch",
      description: "No pre-sales, no insider allocations. Equal opportunity for every degen.",
      icon: <Scale className="w-6 h-6" />,
      accent: "purple"
    },
    {
      title: "No VCs Allowed",
      description: "We don't take VC money. We don't want their 'strategic partnerships'. F*ck 'em.",
      icon: <Ban className="w-6 h-6" />,
      accent: "red"
    },
    {
      title: "Free Forever",
      description: "Your pain is your ticket in. We want your rage, not your rent money.",
      icon: <Ticket className="w-6 h-6" />,
      accent: "pink"
    },
    {
      title: "Deflationary",
      description: "Aggressive buyback & burn. The supply only goes one way: Down.",
      icon: <Flame className="w-6 h-6" />,
      accent: "orange"
    },
    {
      title: "DAO Governed",
      description: "Community calls the shots. No suits, no ties, just pure chaos.",
    ...
    <section className="relative py-32 bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-40 right-10 w-[500px] h-[500px] bg-purple-600 rounded-full mix-blend-multiply filter blur-[100px] animate-pulse" style={{ animationDuration: '8s' }} />
          <div className="absolute bottom-20 left-10 w-[500px] h-[500px] bg-red-500 rounded-full mix-blend-multiply filter blur-[100px] animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl sm:text-2xl text-gray-400 max-w-2xl mx-auto font-light">
            Built by degens, <span className="text-white font-bold">for degens.</span> No suits allowed.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
          ...
          {/* LEFT: Feature Cards - Dynamic Stack */}
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-xl bg-black/40 border border-white/10 text-gray-400 group-hover:text-${feature.accent}-400 group-hover:border-${feature.accent}-500/30 transition-all shrink-0`}>
                    {feature.icon}
                  </div>
                  <div>
          ...
          {/* RIGHT: Mint Process - Large Hero Card */}
              ...
              <div className="relative space-y-8 z-10">
                ...
                <div className="mb-15">
                  ...
                  <h3 className="text-4xl md:text-5xl font-black text-white mb-3 leading-tight">
                    Mint in <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-500">3 Steps</span>
                  </h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="pt-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-lg font-bold text-white uppercase tracking-wide">Connect</h4>
                      </div>
                      <p className="text-sm text-gray-400">Link your Solana wallet</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="pt-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-lg font-bold text-white uppercase tracking-wide">Share</h4>
                      </div>
                      <p className="text-sm text-gray-400">Tell your crypto horror story</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="pt-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h4 className="text-lg font-bold text-white uppercase tracking-wide">Mint</h4>
                      </div>
                      <p className="text-sm text-gray-400">Initiate Your $PAINN Mint</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="relative bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 divide-x-0 md:divide-x divide-white/10">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Fair Launch</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Team & VC Allocation</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">VC Funds</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Degen Power</div>
            </div>
          </div>
        </div>
