...
const Footer: React.FC = () => {
  return (
    <footer className="footer relative bg-gradient-to-b from-black via-gray-950 to-black border-t-2 border-purple-500/30 overflow-hidden">
      {/* Background orbs — blur stripped on mobile via performance.css */}
      <div className="absolute inset-0 opacity-10">
        ...
        <div
          className="absolute bottom-20 right-10 w-64 h-64 bg-pink-600 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed max-w-md">
              Transforming crypto pain into unstoppable power. Built by degens,
              for degens, with degens.
            </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-400 leading-relaxed mb-2">
                <span className="font-bold text-pink-400">DISCLAIMER:</span>{' '}
                MAXXPAINN is an experimental project. This is{' '}
                <span className="text-pink-400 font-semibold">NOT</span>{' '}
                financial advice. Cryptocurrency investments carry high risk.
