...
const PAIN_EVENTS = [
  ...
  { code: "RUG-003", emoji: "⚰️", name: "Endless Rug Pulls", loss: "$10B+", year: "ongoing", color: "#ff2d78", tagline: "SafeMoon, Iron Finance, Titan — the graveyard grows.", detail: "Exit liquidity wears many masks: 'revolutionary DeFi', 'community-driven', 'audited by top firms'." },
