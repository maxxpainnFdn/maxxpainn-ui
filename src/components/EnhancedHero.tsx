...
import { TrendingDown, Skull, Flame, Zap, FileText, Map, BookOpen } from 'lucide-react';
...
const painStories = useMemo(() => [
  ...
  // --- FUTURE/TIME TRAVELER (Speculative Pain) ---
  ...
  const glitchVariants = useMemo(() =>['MAXXPAINN', 'M4XXPA1NN', 'MAX%PA!NN', 'MA%XPA!NN'], []);
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setPainLevel(prev => (prev < 100 ? prev + 0.5 : 0));
    }, 30);
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-purple-900/20">
      
      {/* --- BACKGROUND LAYERS --- */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Multiple layered animated gradient orbs */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-20 left-10 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '7s' }} />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-pink-600 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '9s', animationDelay: '2s' }} />
          <div className="absolute top-1/2 left-1/3 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '8s', animationDelay: '4s' }} />
          <div className="absolute bottom-1/3 right-1/4 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '10s', animationDelay: '1s' }} />
          <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDuration: '11s', animationDelay: '3s' }} />
        </div>
        ...
        <div className="absolute bottom-0 right-0 w-full h-full bg-gradient-radial from-pink-900/10 via-transparent to-transparent" />

        {/* Animated grid overlay with depth */}
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(236,72,153,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(236,72,153,0.03)_1px,transparent_1px)] bg-[size:50px_50px] opacity-20" style={{ transform: 'translateZ(0)' }} />

        {/* Floating animated geometric shapes */}
        <div className="absolute top-20 left-20 w-4 h-4 border-2 border-purple-500/40 rotate-45 animate-spin" style={{ animationDuration: '20s' }} />
        <div className="absolute top-40 right-32 w-6 h-6 border-2 border-pink-500/40 rounded-full animate-ping" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-32 right-20 w-5 h-5 border-2 border-red-500/30 rotate-12 animate-spin" style={{ animationDuration: '15s' }} />
        <div className="absolute bottom-20 left-32 w-3 h-3 border-2 border-purple-400/40 animate-pulse" style={{ animationDuration: '3s' }} />
        <div className="absolute top-1/3 right-16 w-3 h-3 bg-pink-500/50 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-1/3 left-16 w-2 h-2 bg-purple-500/50 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-2/3 left-1/4 w-4 h-4 border-2 border-pink-400/30 rotate-45" />
        <div className="absolute top-1/4 right-1/3 w-3 h-3 bg-red-500/40 animate-pulse" style={{ animationDelay: '0.5s' }} />

        {/* Flowing light streaks */}
        <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-purple-500/30 to-transparent animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-pink-500/20 to-transparent animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }} />
        <div className="absolute top-0 left-2/3 w-px h-full bg-gradient-to-b from-transparent via-red-500/20 to-transparent animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-pulse" style={{ top: '25%', animationDuration: '3s' }} />
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-pink-400 to-transparent animate-pulse" style={{ top: '50%', animationDuration: '4s', animationDelay: '1s' }} />
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-pulse" style={{ top: '75%', animationDuration: '3.5s', animationDelay: '2s' }} />
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-32 pb-20 flex flex-col items-center">
        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="relative mb-8 p-4">
            <div className="absolute inset-0 pointer-events-none">
              {titleParticles.map(particle => (
                <div
                  key={particle.id}
                  className="absolute w-1 h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full blur-[0.5px]"
                  style={{
                    left: `${particle.x}%`,
                    top: `${particle.y}%`,
            ...
            <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl max-w-[95%] font-black tracking-tight select-none relative z-10">
              <span className="bg-gradient-to-b from-white via-purple-200 to-purple-400 bg-clip-text text-transparent opacity-20 absolute top-1 left-1 blur-sm">
                {glitchText}
              </span>
          ...
          <div className="h-14 flex items-center justify-center w-full">
            <div className="max-w-[96%] mx-1 inline-flex items-center gap-4 text-lg sm:text-xl md:text-3xl text-gray-300 font-bold bg-black/30 px-8 py-2 rounded-2xl border border-white/5 backdrop-blur-sm">
        ...
        <div className="w-full max-w-5xl bg-gray-900/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-4 sm:p-8 md:p-14 shadow-[0_0_40px_rgba(0,0,0,0.5)] relative overflow-hidden group">
          ...
          <div className="max-w-xl mx-auto mb-12 relative">
            <div className="flex justify-between text-xs font-bold text-gray-400 mb-3 tracking-wider">
              <span className="flex items-center gap-2"><Skull size={14} className="text-gray-500" />PAIN</span>
              <span className="text-lg text-purple-400 font-black tracking-tighter shadow-purple-500/20 drop-shadow-lg">{Math.round(painLevel)}%</span>
              <span className="flex items-center gap-2">GAIN<Zap size={14} className="text-yellow-400" /></span>
            </div>
            ...
            <div className="h-5 bg-black/60 rounded-full overflow-hidden border border-white/10 shadow-[inset_0_2px_4px_rgba(0,0,0,0.6)] relative p-0.5">
              <div 
                className="h-full rounded-full bg-gradient-to-r from-red-600 via-orange-500 to-green-400 relative shadow-[0_0_15px_rgba(239,68,68,0.5)]"
                style={{ width: `${painLevel}%`, transition: 'width 0.1s linear' }}
              >
          ...
          <div className="text-center mb-14">
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300/90 leading-relaxed max-w-3xl mx-auto font-light">
              Every degen knows the pain. The rugs that stole our dreams. The liquidations that crushed our souls.
          ...
          {/* Info Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14 px-2">
            {[
              { title: "100% FREE MINT", sub: "For Everybody", border: "border-red-500/20", bg: "hover:bg-red-500/5", text: "text-red-400" },
              { title: "NO BULLSHIT", sub: "Pure Degen Tokenomics", border: "border-purple-500/20", bg: "hover:bg-purple-500/5", text: "text-purple-400" },
              { title: "REVENGE", sub: "Against The System", border: "border-green-500/20", bg: "hover:bg-green-500/5", text: "text-green-400" }
            ].map((item, idx) => (
              <div key={idx} className={`bg-black/20 border ${item.border} rounded-2xl p-6 text-center ${item.bg} transition-all duration-300 hover:-translate-y-1`}>
                <div className={`text-xl font-black ${item.text} mb-2 tracking-tight`}>{item.title}</div>
                <div className="text-sm text-gray-400 font-medium tracking-wide">{item.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-5 justify-center items-center w-full">
            ...
            <Link to="/whitepaper" className="w-full md:w-auto flex-1 md:flex-none">
              <button className="w-full px-8 py-5 bg-gray-900 hover:bg-gray-800 border border-green-500/20 text-green-400/90 font-bold rounded-2xl text-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(74,222,128,0.1)] hover:border-green-500/50 flex items-center justify-center gap-3 group">
                <FileText className="w-5 h-5 group-hover:text-green-300" />
                Whitepaper
              </button>
            </Link>

            <Link to="/roadmap" className="w-full md:w-auto md:min-w-[240px] order-first md:order-none">
              <button className="font-bold w-full px-10 py-5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-2xl text-xl shadow-[0_0_30px_rgba(168,85,247,0.3)] hover:shadow-[0_0_50px_rgba(236,72,153,0.5)] transition-all duration-300 hover:scale-[1.03] flex items-center justify-center gap-3 relative overflow-hidden">
            ...
            <Link to="/manifesto" className="w-full md:w-auto flex-1 md:flex-none">
              <button className="w-full px-8 py-5 bg-gray-900 hover:bg-gray-800 border border-purple-500/20 text-purple-400/90 font-bold rounded-2xl text-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(168,85,247,0.1)] hover:border-purple-500/50 flex items-center justify-center gap-3 group">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 lg:gap-6  w-full max-w-6xl px-4">
          {[
            { value: "$2.1T+", label: "Market Pain", color: "text-red-500", glow: "group-hover:shadow-red-900/20" },
            { value: "1M+", label: "Degens United", color: "text-purple-500", glow: "group-hover:shadow-purple-900/20" },
            { value: "∞", label: "Free Mints", color: "text-pink-500", glow: "group-hover:shadow-pink-900/20" },
            { value: "24/7", label: "Revenge Mode", color: "text-green-500", glow: "group-hover:shadow-green-900/20" },
          ].map((stat, idx) => (
            <div key={idx} className={`flex flex-col items-center justify-center bg-gray-900/30 border border-white/5 backdrop-blur-sm rounded-2xl p-4 md:p-8 text-center hover:-translate-y-1 transition-all duration-300 group hover:bg-gray-800/50 hover:border-white/10 shadow-lg ${stat.glow}`}>
              <div className={`text-2xl sm:text-4xl font-black ${stat.color} mb-2 drop-shadow-sm`}>{stat.value}</div>
              <div className="text-gray-400 font-bold text-sm tracking-widest uppercase">{stat.label}</div>
              <div className="text-[11px] text-gray-600 font-mono mt-2 hidden group-hover:inline-block transition-opacity">
                {idx === 0 ? "And Counting..." : idx === 1 ? "Growing Daily" : idx === 2 ? "No Limits" : "Never Stops"}
              </div>
            </div>
          ))}
        </div>
